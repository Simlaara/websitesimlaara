...
<section class="home" id="home">
   ...
   <div class="image" data-aos="fade-right">
      <img src="images/simlaa.jpg" alt="">
   </div>

   <div class="content">
      <h3 data-aos="fade-up">hi, i am simla Ara</h3>
      <span data-aos="fade-up">web designer & developer</span>
      <p data-aos="fade-up">HLw i am simlaara.i completed my study AIUB
         (2022).i am expert HTML,CSS, JavaScript,BootStarp,php,REACT.JS(framwork),Laravel(framwork)</p>
...
<section class="about" id="about">
   ...
   <div class="biography">
      ...
      <div class="bio">
         <h3 data-aos="zoom-in"> <span>name : </span> simla Ara </h3>
         <h3 data-aos="zoom-in"> <span>email : </span> simlaara@yahoo.com </h3>
         <h3 data-aos="zoom-in"> <span>address : </span> Dhaka,Bangladesh </h3>
         <h3 data-aos="zoom-in"> <span>phone : </span> 01783298179 </h3>
...
<section class="contact" id="contact">
   ...
   <div class="box-container">
      ...
      <div class="box" data-aos="zoom-in">
         ...
         <h3>email</h3>
         <p>simlaara@yahoo.com</p>
      </div>

      <div class="box" data-aos="zoom-in">
         <i class="fas fa-map-marker-alt"></i>
         <h3>address</h3>
         <p>phulbari,Dinajpur</p>
      </div>
